...
{-
   ...
   suite11 =
       describe "Day11"
           [ test "isOccupied out of bounds returns false test"
               (\_ ->
                   let
                       pos =
                           ( 5, -1 )
                   ...
                   Expect.equal
                       False
                       (Day11.isOccupied after1Step pos)
               )
           , test "Part one with test input"
               (\_ -> Expect.equal 37 (Day11.solve1 Day11.test))
           , test "Part one with actual input"
               (\_ -> Expect.equal 2281 (Day11.solve1 Day11.actual))
           , test "Part two with test input"
               (\_ -> Expect.equal 26 (Day11.solve2 Day11.test))
           , test "Part two with actual input"
               (\_ -> Expect.equal 2085 (Day11.solve2 Day11.actual))
           , test "toString"
               (\_ -> Expect.equal Day11.test (Day11.toString <| Day11.parse Day11.test))
           , test "step with test"
               (\_ ->
                   Expect.equal
                       Day11.after1Step
                       (Day11.toString <| Day11.step <| Day11.parse Day11.test)
               )
           , test "step 2 with test"
               (\_ ->
                   Expect.equal
                       Day11.after2Step
                       (Day11.toString after2Step)
               )
           , test "step 5 with test"
               (\_ ->
                   Expect.equal
                       Day11.after5Step
                       (Day11.toString after5Step)
               )
           , test "step 2_2 with test"
               (\_ ->
                   Expect.equal
                       Day11.t2_2
                       (Day11.toString <| Day11.step2 <| Day11.step2 <| Day11.parse Day11.test)
               )
           , test "step 2_3 with test"
               (\_ ->
                   Expect.equal
                       Day11.t2_3
                       (Day11.toString <|
...
suite12 =
    describe
        ...
        [ test "Part 1 with test input"
            (\_ ->
                Expect.equal 25 (Day12.solve1 Day12.test)
            )
        , test "Part 1 with actual input"
            (\_ ->
                Expect.equal 1838 (Day12.solve1 Day12.actual)
            )
        , test "Part 2 with test input"
            (\_ ->
                Expect.equal 286 (Day12.solve2 Day12.test)
            )
        , test "Part 2 with actual input"
            (\_ ->
                Expect.equal 89936 (Day12.solve2 Day12.actual)
            )
        ]
